...
projectEntityFromJson(ProjectEntity data, Map<String, dynamic> json) {
	...
	if (json['tags'] != null) {
		data.tags = new List<ProjectTag>();
		(json['tags'] as List).forEach((v) {
			data.tags.add(new ProjectTag().fromJson(v));
		});
	}
	if (json['title'] != null) {
...
projectTagFromJson(ProjectTag data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> projectTagToJson(ProjectTag entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
