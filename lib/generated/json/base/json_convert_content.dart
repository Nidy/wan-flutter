...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case BannerEntity:
			return bannerEntityFromJson(data as BannerEntity, json) as T;			case CategoryEntity:
			...
			return projectTagFromJson(data as ProjectTag, json) as T;    }
    return data as T;
  }

  static _getToJson<T>(Type type, data) {
		switch (type) {			case BannerEntity:
			return bannerEntityToJson(data as BannerEntity);			case CategoryEntity:
			...
			return projectTagToJson(data as ProjectTag);    }
    return data as T;
  }
  //Go back to a single instance by type
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'BannerEntity':
			return BannerEntity().fromJson(json);			case 'CategoryEntity':
			...
			return ProjectTag().fromJson(json);    }
    return null;
  }
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'BannerEntity':
			return List<BannerEntity>();			case 'CategoryEntity':
